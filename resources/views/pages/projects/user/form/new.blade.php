                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('finish_day', null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('published_budget', null, ['class' => 'form-control', 'min' => 0]) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('skills[]', $skills, null, ['class' => 'form-control select2','multiple' => true]) !!}
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-red">Ajukan Ke Admin</button>
                        </div>
                        {!! Form::close() !!}
                    </div><!-- Section Box -->
                </div>
